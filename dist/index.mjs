...
export { ClinicalPatterns, ECGExporter, ECGGenerator, ECGRenderer, LEADS, LIMB_LEADS, PRECORDIAL_LEADS, getAnatomicalRegion, getLeadAmplitudeMultiplier, getLeadVector };
