...
const ECGCanvas = forwardRef(({ configuration = {}, renderOptions = {}, pattern = 'normal', width = 1200, height = 800, onECGGenerated, className, style }, ref) => {
    const canvasRef = useRef(null);
    const rendererRef = useRef(null);
    const generatorRef = useRef(null);
    const currentECGDataRef = useRef(null);
    ...
    return (jsx("canvas", { ref: canvasRef, width: width, height: height, className: className, style: style }));
});
...
const ECGControlPanel = ({ onConfigurationChange, onPatternChange, onRenderOptionsChange, initialConfiguration = {}, initialPattern = 'normal', initialRenderOptions = {}, className, style }) => {
    ...
    return (jsx("div", { className: className, style: style, children: jsxs("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }, children: [jsx("div", { children: jsxs("label", { children: ["Heart Rate (bpm): ", config.heartRate, jsx("input", { type: "range", min: "40", max: "150", value: config.heartRate, onChange: (e) => handleConfigChange('heartRate', parseInt(e.target.value)) })] }) }), jsx("div", { children: jsxs("label", { children: ["Duration (s): ", config.duration, jsx("input", { type: "range", min: "5", max: "30", value: config.duration, onChange: (e) => handleConfigChange('duration', parseInt(e.target.value)) })] }) }), jsx("div", { children: jsxs("label", { children: ["Amplitude: ", config.amplitude, jsx("input", { type: "range", min: "0.5", max: "2", step: "0.1", value: config.amplitude, onChange: (e) => handleConfigChange('amplitude', parseFloat(e.target.value)) })] }) }), jsx("div", { children: jsxs("label", { children: ["Display Gain: ", renderOptions.gain, jsx("input", { type: "range", min: "5", max: "25", value: renderOptions.gain, onChange: (e) => handleRenderOptionChange('gain', parseInt(e.target.value)) })] }) }), jsx("div", { children: jsxs("label", { children: ["Clinical Pattern:", jsxs("select", { value: pattern, onChange: (e) => handlePatternChange(e.target.value), children: [jsx("option", { value: "normal", children: "Normal" }), jsx("option", { value: "stemi-anterior", children: "STEMI - Anterior" }), jsx("option", { value: "stemi-inferior", children: "STEMI - Inferior" }), jsx("option", { value: "stemi-lateral", children: "STEMI - Lateral" }), jsx("option", { value: "nstemi", children: "NSTEMI" }), jsx("option", { value: "pericarditis", children: "Pericarditis" }), jsx("option", { value: "lvh", children: "Left Ventricular Hypertrophy" }), jsx("option", { value: "rbbb", children: "Right Bundle Branch Block" }), jsx("option", { value: "lbbb", children: "Left Bundle Branch Block" })] })] }) }), jsx("div", { children: jsxs("label", { children: [jsx("input", { type: "checkbox", checked: renderOptions.showGrid, onChange: (e) => handleRenderOptionChange('showGrid', e.target.checked) }), "Show Grid"] }) }), jsx("div", { children: jsxs("label", { children: [jsx("input", { type: "checkbox", checked: renderOptions.showLabels, onChange: (e) => handleRenderOptionChange('showLabels', e.target.checked) }), "Show Labels"] }) })] }) }));
};
const ECGSimulator = ({ width = 1200, height = 800, initialConfiguration = {}, initialPattern = 'normal', initialRenderOptions = {}, onECGGenerated, showControls = true, className, style }) => {
    ...
    return (jsxs("div", { className: className, style: style, children: [showControls && (jsxs(Fragment, { children: [jsx(ECGControlPanel, { onConfigurationChange: handleConfigurationChange, onPatternChange: handlePatternChange, onRenderOptionsChange: handleRenderOptionsChange, initialConfiguration: config, initialPattern: pattern, initialRenderOptions: renderOptions, style: { marginBottom: '1rem', padding: '1rem', backgroundColor: '#f8f9fa', borderRadius: '0.5rem' } }), jsxs("div", { style: { marginBottom: '1rem', display: 'flex', gap: '0.5rem' }, children: [jsx("button", { onClick: handleExportJSON, style: { padding: '0.5rem 1rem', backgroundColor: '#007bff', color: 'white', border: 'none', borderRadius: '0.25rem' }, children: "Export JSON" }), jsx("button", { onClick: handleExportCSV, style: { padding: '0.5rem 1rem', backgroundColor: '#007bff', color: 'white', border: 'none', borderRadius: '0.25rem' }, children: "Export CSV" }), jsx("button", { onClick: handleExportSVG, style: { padding: '0.5rem 1rem', backgroundColor: '#007bff', color: 'white', border: 'none', borderRadius: '0.25rem' }, children: "Export SVG" })] })] })), jsx(ECGCanvas, { ref: ecgCanvasRef, configuration: config, renderOptions: renderOptions, pattern: pattern, width: width, height: height, onECGGenerated: onECGGenerated, style: { border: '1px solid #ddd' } })] }));
};

export { ECGCanvas, ECGControlPanel, ECGSimulator };
